...
const comparisonData = [
  { feature: "Cost (Yearly)", notion: "₹9,600+", others: "₹15,000-24,000+", sheetly: "₹1,299 ONCE ✅", highlight: true },
  { feature: "5-Year Total Cost", notion: "₹48,000", others: "₹75,000-1,20,000", sheetly: "Still ₹1,299 ✅", highlight: true },
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-10 relative z-10">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-base md:text-xl text-secondary max-w-2xl mx-auto font-normal">
            Why pay ₹2,000/month forever when you can pay ₹1,299 ONCE? See the brutal truth in numbers.
          </p>
        </div>
