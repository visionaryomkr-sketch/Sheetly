  ...
  const featureBlocks: FeatureBlockData[] = [
    {
      ...
      "Client Snapshot:— Select any client and instantly see their full details, last communication, and invoice status — all on one screen.",
      "Team Activity at a Glance:— Know what your team is working on right now without a single WhatsApp message.",
      "Quick Navigation:— Hyperlinks to every tab directly from the Dashboard — CRM, Invoices, Tasks, Calendar, Finance, and more."],
      images: [
