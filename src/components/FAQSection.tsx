...
const faqs: FAQItem[] = [
  {
    ...
    answer: "It's a one-time payment of ₹1,299 only. No monthly fees, no hidden costs. You get lifetime access to the entire system and all future updates for free."
  },
  {
